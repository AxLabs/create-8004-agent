...
import {
    DEFAULT_FIXTURE_IMAGE_URI,
    NEOX_T4_CHAIN_ID,
    NEOX_T4_CHAIN_KEY,
    NEOX_T4_EXPLORER_URL,
    NEOX_T4_FAUCET_URL,
...
export function getNeoxIdentityRegistry(): typeof NEOX_T4_IDENTITY_REGISTRY {
    return NEOX_T4_IDENTITY_REGISTRY;
}

export async function resolveNeoxLibraryDir(): Promise<string> {
...
export async function copyNeoxLibrary(projectPath: string): Promise<void> {
...
export function generateNeoxRegisterEntry(): string {
    return `/**
...
export function generateNeoxGitignore(): string {
    return `node_modules/
dist/
.env
