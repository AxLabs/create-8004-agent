...
import {
    ...
    createNeoxPublicClient,
    createNeoxWalletClient,
...
export function parseNeoxCliCommand(argv = process.argv.slice(2)): NeoxCliCommand {
...
export async function runNeoxRegistrationCli(
