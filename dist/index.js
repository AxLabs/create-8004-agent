...
import { NEOX_T4_FAUCET_URL, NEOX_T4_NATIVE_CURRENCY, } from "./neox/constants.js";
...
function printNextSteps(answers, isSolana, neox) {
    let step = 1;
...
async function generateFromAnswers(answers, skipInstall) {
    console.log("\n");
